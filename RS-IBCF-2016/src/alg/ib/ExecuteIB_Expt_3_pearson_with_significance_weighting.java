...
public class ExecuteIB_Expt_3_pearson_with_significance_weighting
{
	public static void main(String[] args)
	{
		int neighbourhoodSize = 70;
		...
		SimilarityMetric metric = new PearsonWithSignificanceWeightingMetric();
